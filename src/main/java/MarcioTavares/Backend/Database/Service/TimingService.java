...
public class TimingService {
    ...
    // Getter for attendanceRepository
    ...
    public AttendanceSheet clockOut() {
        ...
        System.out.println("Clock-out at: " + att.getClockOutTime() + ", Total hours: " + att.getTotalHours() + ", Break minutes: " + att.getBreakInMinutes());
